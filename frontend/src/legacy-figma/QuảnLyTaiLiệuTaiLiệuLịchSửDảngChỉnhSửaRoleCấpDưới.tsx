import svgPaths from "./svg-vjbji446i3";
    ...
    <div className="bg-[#b9000e] h-[60px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center p-[10px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] min-h-px min-w-px not-italic relative text-[18px] text-white whitespace-pre-wrap">Chỉnh sửa tài liệu về Lịch sử Đảng</p>
...
function MyIcon() {
  return (
    <div className="overflow-clip relative shrink-0 size-[18px]" data-name="myIcon (8) 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Group">
          <path d={svgPaths.p748e500} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame3() {
  return (
    <div className="bg-[#b9000e] content-stretch flex gap-[10px] h-[36px] items-center p-[10px] relative rounded-[8px] shrink-0">
      <MyIcon />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-white">Lưu</p>
    </div>
  );
}
...
export default function QunLyTaiLiuTaiLiuLchSDngChnhSaRoleCpDi() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Quản lý tài liệu >> Tài liệu lịch sử Đảng >> Chỉnh sửa >> Role cấp dưới">
      <PopupCreateTypeJob />
    </div>
  );
}