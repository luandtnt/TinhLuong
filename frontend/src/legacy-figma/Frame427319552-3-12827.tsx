import svgPaths from "./svg-plyngvb3lg";
...
function Frame1() {
  return (
    <div className="bg-[#b9000e] content-stretch flex gap-[10px] h-[36px] items-center p-[10px] relative rounded-[8px] shrink-0">
      <MyIcon />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-white">Lưu nháp</p>
    </div>
  );
}
