import svgPaths from "./svg-7sejuj2a4t";
...
function MiExport() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="mi:export">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="mi:export">
          <path d={svgPaths.p3d2a5200} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ButtonWeb2() {
  return (
    <div className="bg-[#b9000e] relative rounded-[8px] shrink-0" data-name="Button web">
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip px-[14px] py-[8px] relative rounded-[inherit]">
        <MiExport />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-white">Nộp cấp trên</p>
      </div>
...
export default function QunLyTaiLiuTaiLiuLchSDngXemRoleCpDi() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Quản lý tài liệu >> Tài liệu lịch sử Đảng >> Xem >> Role cấp dưới">
      <PopupCreateTypeJob />
    </div>
  );
}