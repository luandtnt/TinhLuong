...
export function EditDataSourceModal({ document: documentData, onClose }: EditDataSourceModalProps) {
  const [formData, setFormData] = useState({
    documentCode: documentData.code,
  ...
  const [uploadedFiles, setUploadedFiles] = useState<UploadedFile[]>([
    ...
    { id: '2', name: 'vlbn002-nhap-du-lieu-nguoi-su', type: 'word' }
  ]);
  ...
  const handleSubmit = () => {
    console.log('Form updated:', formData, uploadedFiles);
    onClose();
  };

  return (
    <div className="bg-[rgba(0,0,0,0.3)] fixed inset-0 flex items-center justify-center p-4 z-50">
        ...
        <div className="p-[16px] flex flex-col gap-[16px]">
          ...
          <div className="flex gap-[16px]">
            ...
            <div className="flex-1 flex flex-col gap-[4px]">
              ...
              <input
                ...
                className="bg-white h-[36px] px-[12px] py-[8px] rounded-[8px] border border-[#c9cdd4] text-[14px] text-[#111827] leading-[20px] outline-none focus:border-[#b9000e] placeholder:text-gray-400"
              />
            </div>
          </div>
          ...
          <div className="flex gap-[12px]">
              ...
              {uploadedFiles.map((file) => (
                <div key={file.id} className="relative border border-[#bfbfbf] rounded-[8px] p-[12px] flex flex-col gap-[16px] items-center w-[210px]">
                  <div className="w-[40px] h-[40px] flex items-center justify-center">
                    {file.type === 'excel' ? <ExcelIcon /> : <WordIcon />}
                  </div>
            ...
            <div className="border border-[#bdbdbd] rounded-[8px] p-[10px] w-[340px]">
              <div className="text-[14px] text-[#414142] space-y-2">
...
function ExcelIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
      ...
      <path d="M12 10h16v20H12V10z" fill="#EBEEF0" />
      <path d="M16 16l4 4-4 4m8-8l-4 4 4 4" stroke="#217346" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
function WordIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
      <rect width="40" height="40" rx="4" fill="#2B579A" />
      <path d="M12 10h16v20H12V10z" fill="#EBEEF0" />
      <path d="M15 16h10M15 20h10M15 24h6" stroke="#2B579A" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
